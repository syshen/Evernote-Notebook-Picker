...
- (BOOL)tableView:(ExpandableTableView *)tableView shouldExpandSection:(NSUInteger)section;
- (BOOL)tableView:(ExpandableTableView *)tableView shouldConstractSection:(NSUInteger)section;
...
- (CGFloat)tableView:(ExpandableTableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath;
- (CGFloat)tableView:(ExpandableTableView *)tableView heightForGroupCellAtIndexPath:(NSIndexPath *)indexPath;
