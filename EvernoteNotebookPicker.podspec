#
#  Be sure to run `pod spec lint EvernoteNotebookPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/EvernoteNotebookPicker"
  ...
  # s.authors          = { "syshen" => "sysheen@gmail.com", "other author" => "email@address.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/EvernoteNotebookPicker.git", :tag => "0.0.1" }
